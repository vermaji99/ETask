        ...
        <div className="bg-white py-10 px-8 shadow-2xl shadow-slate-200/50 sm:rounded-3xl border border-slate-100 mx-4 sm:mx-0">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <select
                className="w-full bg-slate-50 border-none rounded-2xl py-4 px-6 focus:ring-2 focus:ring-indigo-500 text-slate-900 font-bold transition-all appearance-none cursor-pointer"
                value={formData.role}
          ...
          <div className="mt-10 text-center">
            <p className="text-sm text-slate-500 font-medium">
              ...
              <Link to="/login" className="font-black text-indigo-600 hover:text-indigo-700 transition-colors">
                Sign in instead
              </Link>
            </p>
          </div>
